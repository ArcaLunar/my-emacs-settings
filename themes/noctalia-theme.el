...
(let* ((bg "#0f1417")
      ...
      (on-primary "#003549")
      (on-primary-container "#003c53")
      (on-secondary "#033448")
      (on-secondary-container "#93bad3")
      (on-surface "#dee3e8")
      (on-surface-variant "#bdc8d0")
      (on-tertiary "#4c116b")
      (on-tertiary-container "#541a72")
      (outline-color "#87929a")
      (outline-variant "#3e484f")
      (primary "#79d1ff")
      (primary-container "#1aace4")
      (secondary "#a4cce5")
      (secondary-container "#224b60")
      (shadow "#000000")
      (surface "#0f1417")
      ...
      (surface-variant "#3e484f")
      (tertiary "#e7b3ff")
      (tertiary-container "#c688e5")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#e7b3ff")
      (on-success "#4c116b")
      (success-container "#c688e5")
      (on-success-container "#541a72")
      ;; Map fixed colors to regular colors
      (primary-fixed "#79d1ff")
      (primary-fixed-dim "#1aace4")
      (secondary-fixed "#a4cce5")
      (secondary-fixed-dim "#224b60")
      (tertiary-fixed "#e7b3ff")
      (tertiary-fixed-dim "#c688e5")
      (on-primary-fixed "#003549")
      (on-primary-fixed-variant "#003c53")
      (on-secondary-fixed "#033448")
      (on-secondary-fixed-variant "#93bad3")
      (on-tertiary-fixed "#4c116b")
      (on-tertiary-fixed-variant "#541a72")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#dee3e8")
      (inverse-primary "#79d1ff")
      (inverse-surface "#0f1417")
